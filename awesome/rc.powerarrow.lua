...
vicious.register(netwidget, vicious.widgets.net, function(widgets,args)
        ...
        if args["{enp3s0 carrier}"] == 1 then
                interface = "enp3s0"
        elseif args["{tun0 carrier}"] == 1 then
                interface = "tun0"
        else
                return ""
        end
...
vicious.register(memwidget, vicious.widgets.mem, '<span background="#1F2428" font="Inconsolata 11"> <span font="Inconsolata 11" color="#AAAAAA" background="#1F2428">$1% </span></span>', 20)
