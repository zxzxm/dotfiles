...
calendarCA :: CA
calendarCA = CA
	{ leftClickCA   = "/home/thermans/bin/dzencal.sh"
	, middleClickCA = "/home/thermans/bin/dzencal.sh"
	, rightClickCA  = "/home/thermans/bin/dzencal.sh"
	, wheelUpCA     = "/home/thermans/bin/dzencal.sh"
	, wheelDownCA   = "/home/thermans/bin/dzencal.sh"
	}
...
myStartupHook =
	...
	(spawn "/home/thermans/.xmonad/apps/haskell-cpu-usage.out 5") <+>
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
	...
	, ((0, 0x1008ffa9), spawn "/home/thermans/bin/touchpadtoggle.sh")                                                       --Toggle touchpad (xmodmap -pk | grep -i toggle)
	, ((0, xF86XK_AudioMute), spawn "/home/thermans/bin/voldzen.sh t -d")                                                   --Mute/unmute volume
	, ((0, xF86XK_AudioRaiseVolume), spawn "/home/thermans/bin/voldzen.sh + -d")                                            --Raise volume
	, ((mod1Mask, xK_Up), spawn "/home/thermans/bin/voldzen.sh + -d")
	, ((0, xF86XK_AudioLowerVolume), spawn "/home/thermans/bin/voldzen.sh - -d")                                            --Lower volume
	, ((mod1Mask, xK_Down), spawn "/home/thermans/bin/voldzen.sh - -d")
	...
	, ((0, xF86XK_MonBrightnessUp), spawn "/home/thermans/bin/bridzen.sh")                                                  --Raise brightness
	, ((0, xF86XK_MonBrightnessDown), spawn "/home/thermans/bin/bridzen.sh")                                                --Lower brightness
	, ((0, xF86XK_ScreenSaver), spawn "/home/thermans/bin/turnoffscreen.sh")                                                --Lock screen
	, ((0, 0xff14), spawn "/home/thermans/bin/turnoffscreen.sh")
	, ((0, xK_Print), spawn "/usr/bin/scrot '%Y-%m-%d_$wx$h.png'" >> flashText myTextConfig 1 " Screenshot Saved ")       --Take a screenshot
	, ((modMask , xK_s), spawn "/home/thermans/bin/turnoffscreen.sh")                                                       --Turn off screen
